...
export default class APIClient {
    ...
    syncMessages = async (channel: Channel,opts: SyncOptions) => {
        ...
        const limit = 30;
        const resp = await APIClient.shared.post('https://yvmmss.top/wsapi/channel/messagesync', {
    ...
    syncConversations = async () => {
        ...
        const resp = await APIClient.shared.post('https://yvmmss.top/wsapi/conversation/sync', {
    ...
    clearUnread = async (channel:Channel) => {
       return APIClient.shared.post('https://yvmmss.top/wsapi/conversations/setUnread', {
            uid: WKSDK.shared().config.uid,
            channel_id: channel.channelID,
            channel_type: channel.channelType,
            unread: 0,
    ...
    sendCMD = async (channel:Channel,cmd:string,param?:any) => {
      ...
      return  APIClient.shared.post('https://yvmmss.top/wsapi/message/send', {
            "header": {// 消息头
    ...
    messageStreamStart = (param:any) => {
       return APIClient.shared.post('https://yvmmss.top/wsapi/streammessage/start',param)
    }
    messageStreamEnd = (param:any) => {
        return APIClient.shared.post('https://yvmmss.top/wsapi/streammessage/end',param)
     }
}
